...
namespace AppMovie.Controllers
{
    public class ReturnController : Controller
    {
        ...
        {
            var nombreContext = _context.Return.Include(r => r.Partner);
            return View(await nombreContext.ToListAsync());
        }
       ...
       public IActionResult Create()
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            ViewData["PartnerID"] = new SelectList(_context.Set<Partner>(), "PartnerID", "PartnerName", @return.PartnerID);
            return View(@return);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("RetuenID,ReturnlDate,PartnerID")] Return @return)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'NombreContext.Return'  is null.");
            }
            var @return = await _context.Return.FindAsync(id);
            if (@return != null)
            {
